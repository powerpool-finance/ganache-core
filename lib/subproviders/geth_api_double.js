...
GethApiDouble.prototype.evm_freezeTime = function(date, callback) {
  callback(null, this.state.blockchain.freezeTime(date));
};

GethApiDouble.prototype.evm_unfreezeTime = function(callback) {
  callback(null, this.state.blockchain.unfreezeTime());
};
