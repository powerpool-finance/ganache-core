...
BlockchainDouble.prototype.currentTime = function() {
  return this.frozenTime || (((new Date().getTime() / 1000) | 0) + this.timeAdjustment);
};
...
BlockchainDouble.prototype.freezeTime = function(date) {
  var at = (date.getTime() / 1000) | 0;
  this.frozenTime = at;
};

BlockchainDouble.prototype.unfreezeTime = function() {
  var now = (new Date().getTime() / 1000) | 0;
  var start = this.frozenTime | 0;
  this.timeAdjustment = start - now;
  this.frozenTime = null;
};
